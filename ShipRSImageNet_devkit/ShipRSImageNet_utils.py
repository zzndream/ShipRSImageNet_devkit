...
# import polyiou
"""
    some basic functions which are useful for process ShipRSImageNEt data, based on DOTA_devkit
"""
...
def parse_ShipRSImageNet_poly(filename):
    """
        parse the ShipRSImageNet ground truth in the format:
        [(x1, y1), (x2, y2), (x3, y3), (x4, y4)]
    """
    objects = []
